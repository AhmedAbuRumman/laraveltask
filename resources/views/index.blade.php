    ...
    <div class="container mt-5">
        <div class="row col-md-12 col-md-offset-12 custyle">
            <table class="table table-striped custab">
                ...
                <tbody>
                @foreach($citzien as $x)
                    <tr>
                        <td>{{$x->citzien_id}}</td>
                        <td>{{$x->citzien_fullname}}</td>
                        <td>{{$x->citzien_gender}}</td>
                        <td>{{$x->citzien_city}}</td>
                        <td>{{$x->citzien_nid}}</td>
                        <td>{{$x->citzien_mobile}}</td>
                        <td>{{$x->citzien_address}}</td>
                        <td class="text-center">
                        <a class='btn btn-info btn-xs' href="/edit/{{$x->citzien_id}}"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
                        <a href="/destroy/{{$x->citzien_id}}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a>
                        </td>
                    </tr>
                @endforeach    
                </tbody>
